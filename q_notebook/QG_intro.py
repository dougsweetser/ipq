...
# 
# If you have any interst it playing with the iPython notebook, feel free to download it:
# 
...
# 
# One can difine an exact future class $[f_e]$ where two points are in the future the exact same amount:
# 
...
# 
# <table><tr><td> ![](images/eq_classes/space-1_right.png) </td><td>![](images/eq_classes/space-1_right_exact.png) </td>
# <td> ![](images/eq_classes/space-2_up.png) </td><td>![](images/eq_classes/space-2_up_exact.png) </td>
# <td> ![](images/eq_classes/space-3_near.png) </td><td>![](images/eq_classes/space-3_near_exact.png) </td>
# </tr></table>
# 
...
# 
# <table><tr><td> ![](images/eq_classes/causality_time-like.png) </td><td>![](images/eq_classes/causality_time-like_exact.png) </td></tr></table>
# 
